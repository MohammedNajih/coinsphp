<html>
<head> <title>◔͜͡◔ MOHAMMED ◔͜͡◔</title>
...
<body style='font-family: Yatra One;'>
 ...
 <title>◔͜͡◔ MOHAMMED ◔͜͡◔</title>
 <body>
 <center>
     <?php
error_reporting(0);
echo "<br><br><center><h1>نقاط انستا اب <span></span></h1></center>        <br><center><h1>◔͜͡◔ MOHAMMED ◔͜͡◔ <span></span></h1></center><br>";
...
<div class="container p-2 text-center">
			<button onclick="location.href='https://t.me/onclik'" class="btn btn-primary rounded-circle icon-btn"><i class="fa fa-telegram"></i></button>
			<button onclick="location.href='https://www.instagram.com/4t_ig/ '" class="btn btn-primary rounded-circle icon-btn"><i class="fa fa-instagram"></i></button>
			<p class="text-muted p-5">◔͜͡◔ MOHAMMED ◔͜͡◔</p>
		</div>
